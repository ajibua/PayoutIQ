...
export default function ReviewScreen({ extractedPayees, onConfirmBatch, onBack, API_URL, token, balance }) {
  ...
  return (
    <div className="container anim-fade" style={{ padding: '32px 16px' }}>
      ...
      {balance !== null && totalAmount > balance && (
        <div className="alert alert-warning" style={{ fontSize: '13.5px', borderLeftColor: 'var(--danger)', backgroundColor: 'rgba(244, 63, 94, 0.05)', color: 'var(--danger-text)' }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" style={{ flexShrink: 0, color: 'var(--danger)' }}>
            <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path>
            <line x1="12" y1="9" x2="12" y2="13"></line>
            <line x1="12" y1="17" x2="12.01" y2="17"></line>
          </svg>
          <div>
            <strong>Insufficient Wallet Balance:</strong> The batch total of <strong>{formatCurrency(totalAmount)}</strong> exceeds your current Monnify balance of <strong>{formatCurrency(balance)}</strong>. Please top up your wallet to ensure execution succeeds.
          </div>
        </div>
      )}
